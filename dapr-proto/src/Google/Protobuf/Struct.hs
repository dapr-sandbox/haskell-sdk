...
module Google.Protobuf.Struct where
...
newtype Struct = Struct{structFields ::
                        Hs.Map Hs.Text (Hs.Maybe Google.Protobuf.Struct.Value)}
                 deriving (Hs.Show, Hs.Eq, Hs.Ord, Hs.Generic)

instance Hs.NFData Struct
        ...
        encodeMessage _ Struct{structFields = structFields}
          = (Hs.mconcat
               [(HsProtobuf.encodeMessageField (HsProtobuf.FieldNumber 1)
                   (Hs.unsafeCoerce
                      @(Hs.Map Hs.Text (Hs.Maybe Google.Protobuf.Struct.Value))
                      @(Hs.Map (HsProtobuf.String Hs.Text) (HsProtobuf.Nested Google.Protobuf.Struct.Value))
                      (structFields)))])
        decodeMessage _
          = (Hs.pure Struct) <*>
        ...
        dotProto _
          = [(HsProtobufAST.DotProtoField (HsProtobuf.FieldNumber 1)
                (HsProtobufAST.Map HsProtobufAST.String
                   (HsProtobufAST.Named (HsProtobufAST.Single "Value")))
                      ...
                      -> case x of
                             ...
                             ValueKindListValue y
                               -> (HsProtobuf.encodeMessageField (HsProtobuf.FieldNumber 6)
                                     (Hs.coerce @(Hs.Maybe Google.Protobuf.Struct.ListValue)
                                        @(HsProtobuf.Nested Google.Protobuf.Struct.ListValue)
                                        (Hs.Just y)))])
        decodeMessage _
          = (Hs.pure Value) <*>
                 ...
                 [((HsProtobuf.FieldNumber 1),
                  ...
                  ((HsProtobuf.FieldNumber 6),
                   (Hs.pure (Hs.fmap ValueKindListValue)) <*>
                     (HsProtobuf.coerceOver
                        @(HsProtobuf.Nested Google.Protobuf.Struct.ListValue)
                        @(Hs.Maybe Google.Protobuf.Struct.ListValue)
                        (HsProtobuf.decodeMessageField)))])
        dotProto _ = []
                    ...
                    (let parseKind parseObj
                           = Hs.msum
                               [Hs.Just Hs.. ValueKindNullValue <$>
                                ...
                                Hs.Just Hs.. ValueKindStringValue Hs..
                                  Hs.coerce @(HsProtobuf.String Hs.Text) @(Hs.Text)
...
data ValueKind = ValueKindNullValue (HsProtobuf.Enumerated
                                       Google.Protobuf.Struct.NullValue)
               | ValueKindNumberValue Hs.Double
               | ValueKindStringValue Hs.Text
               | ValueKindBoolValue Hs.Bool
               | ValueKindStructValue Google.Protobuf.Struct.Struct
               | ValueKindListValue Google.Protobuf.Struct.ListValue
               deriving (Hs.Show, Hs.Eq, Hs.Ord, Hs.Generic)

instance Hs.NFData ValueKind
...
newtype ListValue = ListValue{listValueValues ::
                              Hs.Vector Google.Protobuf.Struct.Value}
                    deriving (Hs.Show, Hs.Eq, Hs.Ord, Hs.Generic)

instance Hs.NFData ListValue
...
instance HsProtobuf.Message ListValue where
        encodeMessage _ ListValue{listValueValues = listValueValues}
          = (Hs.mconcat
               [(HsProtobuf.encodeMessageField (HsProtobuf.FieldNumber 1)
                   (Hs.coerce @(Hs.Vector Google.Protobuf.Struct.Value)
                      @(HsProtobuf.NestedVec Google.Protobuf.Struct.Value)
                      (listValueValues)))])
        decodeMessage _
          = (Hs.pure ListValue) <*>
              (HsProtobuf.coerceOver
...
instance HsJSONPB.ToJSONPB ListValue where
        toJSONPB (ListValue f1)
          = (HsJSONPB.object
               ["values" .=
                  (Hs.coerce @(Hs.Vector Google.Protobuf.Struct.Value)
                     @(HsProtobuf.NestedVec Google.Protobuf.Struct.Value)
                     (f1))])
        toEncodingPB (ListValue f1)
          = (HsJSONPB.pairs
               ["values" .=
                  (Hs.coerce @(Hs.Vector Google.Protobuf.Struct.Value)
                     @(HsProtobuf.NestedVec Google.Protobuf.Struct.Value)
